...
async function createMedicine(event) {
    ...
    const medicineDescription = document.getElementById("medication-description").value.trim();
    const medicineUsage = document.getElementById("usage-type").value.trim();
    const medicineTreatments = document.getElementById("treatment-name").value.trim();
